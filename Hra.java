...
public class Hra {
	...
	ImageIcon card = new ImageIcon("HeraCard.png"); //card's image
	...
	String [] Mname = new String [] {"Pomegranate Punch", "Wedding Crashing", "Iuno"}; //array with player's moves for stage3
