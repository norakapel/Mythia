...
public class Hra {
	...
	ImageIcon card = new ImageIcon("photos/HeraCard.png");
	String [] Questions1 = new String [10];
	String [] Rights1 = new String [10];
	String [] Wrongs1 = new String [10];
	String [] Mname = new String [] {"Pomegranate Punch", "Wedding Crashing", "Iuno"};
