...
public class Eleni {
	...
	ImageIcon card = new ImageIcon("photos/HelenCard.png");
	String [] Questions1 = new String [10];
	String [] Rights1 = new String [10];
	String [] Wrongs1 = new String [10];
	String [] Mname = new String [] {"Charm Punch", "Panwraia Eleni", "Seduction"};
	int [] Mdamage = new int [] {15, 30, 20};
