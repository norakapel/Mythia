...
public class Eleni {
	...
	ImageIcon card = new ImageIcon("HelenCard.png"); //card's image
	...
	String [] Mname = new String [] {"Charm Punch", "Panwraia Eleni", "Seduction"}; //array with player's moves for stage3
	int [] Mdamage = new int [] {15, 50, 20}; //array with move's damage for stage3
