...
public class PreferedSettings{
	...
	public void setFrame(JFrame f) {
		...
		try {
			ImageIcon backgroundImage = new ImageIcon("background2.png");
	...
	public void setMenuButtons1( JButton b, int NumberOfButton, int TotalButtons ) {
			b.setBounds((DimMax.width / 2) - 150,(DimMax.height / 2) - (TotalButtons / 2) * 70 + 70 * NumberOfButton, 300, 50);
			b.setBackground(buttonColor);
	}
