...
public class Poseidwnas {
	...
	ImageIcon card = new ImageIcon("PoseidonCard.png"); //card's image
	...
	String [] Mname = new String [] {"Wave Punch", "Trident Attack", "Rain Dance"}; //array with player's moves for stage3
	int [] Mdamage = new int [] {15, 40, 30}; //array with move's damage for stage3
	...
	public Poseidwnas(){
		...
		int j =0;
		String file = "Poseidonas.part1.csv";
