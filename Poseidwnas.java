...
public class Poseidwnas {
	...
	ImageIcon card = new ImageIcon("photos/PoseidonCard.png");
	String [] Questions1 = new String [10];
	String [] Rights1 = new String [10];
	String [] Wrongs1 = new String [10];
	String [] Mname = new String [] {"Wave Punch", "Trident Attack", "Rain Dance"};
	...
	public Poseidwnas(){
		...
		int j =0;
		String file = "csv/Poseidonas1f.csv";
		...
		int j2 =0;
		String file2 = "csv/Poseidonas2f.csv";
