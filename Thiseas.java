...
public class Thiseas {
	...
	ImageIcon card = new ImageIcon("photos/TheseusCard.png");
	String [] Questions1 = new String [10];
	String [] Rights1 = new String [10];
	String [] Wrongs1 = new String [10];
	String [] Mname = new String [] {"Minotaur Punch", "King Attack", "Maze Escape"};
	...
	public Thiseas() {
		...
		int j2 =0;
		String file2 = "csv/Thiseas2f.csv";
