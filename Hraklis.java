...
public class Hraklis {
	...
	ImageIcon card = new ImageIcon("photos/HerculesCard.png");
	String [] Questions1 = new String [10];
	String [] Rights1 = new String [10];
	String [] Wrongs1 = new String [10];
	String [] Mname = new String [] {"Handful of Dwarfs Punch", "Lion Terminator", "Gries"};
	int [] Mdamage = new int [] {25, 30, 20};
	...
	public Hraklis() {
		...
		int j2 =0;
		String file2 = "csv/Hraklis2f.csv";
