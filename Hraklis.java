...
public class Hraklis {

	ImageIcon card = new ImageIcon("HeruclesCard.png"); //card's image
	...
	String [] Mname = new String [] {"Handful of Dwarfs Punch", "Lion Terminator", "Gries"}; //array with player's moves for stage3
	int [] Mdamage = new int [] {25, 30, 20}; //array with move's damage for stage3
