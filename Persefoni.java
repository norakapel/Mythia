...
public class Persefoni {
	...
	ImageIcon card = new ImageIcon("PersephoneCard.png"); //card's image
	...
	String [] Mname = new String [] {"Lively Death Punch", "Dada Attack", "Offspring"}; //array with player's moves for stage3
