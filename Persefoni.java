...
public class Persefoni {
	...
	ImageIcon card = new ImageIcon("photos/PersephoneCard.png");
	String [] Questions1 = new String [10];
	String [] Rights1 = new String [10];
	String [] Wrongs1 = new String [10];
	String [] Mname = new String [] {"Lively Death Punch", "Dada Attack", "Offspring"};
	...
	public Persefoni() {
		...
		int j =0;
		String file = "csv/Persefoni1f.csv";
		...
		int j2 =0;
		String file2 = "csv/Persefoni2f.csv";
