...
public class Odiseas {
	...
	ImageIcon card = new ImageIcon("OdysseusCard.png"); //card's image
	...
	String [] Mname = new String [] {"Polyphemus Punch", "Cyclops Tornado", "The Return"}; //array with player's moves for stage3
