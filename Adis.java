...
public class Adis {
	...
	ImageIcon card = new ImageIcon("HadesCard.png"); //card's image
	...
	String [] Mname = new String [] {"Death Punch", "Varkada Rejection", "Soul Recovery"}; //array with player's moves for stage3
