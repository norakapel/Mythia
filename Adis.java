...
public class Adis {
	...
	ImageIcon card = new ImageIcon("photos/HadesCard.png");
	String [] Questions1 = new String [10];
	String [] Rights1 = new String [10];
	String [] Wrongs1 = new String [10];
	String [] Mname = new String [] {"Death Punch", "Varkada Rejection", "Soul Recovery"};
