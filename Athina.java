...
public class Athina {
	...
	ImageIcon card = new ImageIcon("AthenaCard.png"); //card's image
	...
	String [] Mname = new String [] {"Yfantoripping", "Owl Attack", "Oliver Sykes"}; //array with player's moves for stage3
	int [] Mdamage = new int [] {20, 40, 20}; //array with move's damage for stage3
