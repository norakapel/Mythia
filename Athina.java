...
public class Athina {
	...
	ImageIcon card = new ImageIcon("photos/AthenaCard.png");
	String [] Questions1 = new String [10];
	String [] Rights1 = new String [10];
	String [] Wrongs1 = new String [10];
	String [] Mname = new String [] {"Yfantoripping", "Owl Attack", "Oliver Sykes"};
	int [] Mdamage = new int [] {20, 40, 20};
